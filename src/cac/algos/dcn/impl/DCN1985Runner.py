...
class DCN1985Runner:
    ...
    def build(self, dir_output=None):
        ...
        dir_output_temp = DCN1985Runner.get_dir_output_temp(dir_output)
        for i_iter, dcn in enumerate(dcn_list):
            DCN1985Runner.save_image_helper(i_iter, dcn, dir_output_temp)
            DCN1985Runner.save_geojson(i_iter, dcn, dir_output_temp)
        DCN1985Runner.save_animated_gif(dir_output, dir_output_temp)
