...
from examples.example_3_from_ents_by_population import source as example_3_from_ents_by_population
...
def main():
    for mod in [
        example_1_from_topojson , example_2_from_ents , example_3_from_ents_by_population, example_4_pds,
    ][2:4]:
